...
\input{lect/lect1} % Лекция от 06.02.2019 и начало лекции от 13.02, вплоть до "Волны в ЛП с идеальными ...."

\section{Волны в линиях передачи с идеально проводящими границами}
\input{lect/lect2} % Лекция от 13.02 начиная с этого заголовка

\input{lect/lect3} % Лекция от 20.02

\newpage
\input{lect/lect4} % Лекция от 27.02
